...
def Perfil():
    ...
    return render_template('perfil.html', trofeu_quiz=trofeu_quiz, trofeu_trilha=trofeu_trilha)
...
def Questoes_qcbc():
    ...
    if request.method == 'GET':
        ...
        questao = int(request.cookies.get('questao_atual', 1))  # TODO: Pegar questão que o usuário clicou
